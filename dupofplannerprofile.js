    ...
    function freezeforclientlead(){
        ...
        $.ajax(settings11).done(function (msg) {
            ...
            if (msg.message == "fail") {
                ...
                for (var i = 0; i < freezeClient.length; i++) {
                    $(".freezeclient").append('<option key='+freezeClient[i]+' value='+freezeClient[i]+' style="background-color:#d6d6d6;margin-top:10px" class="getClass form-control">'+freezeClient[i]+'</option>')
                }
                    ...
                    $.ajax(settings11).done(function (msg) {
                        ...
                        setInterval(function(){
                            ...
                            if (msg.message=="fail") {
                                ...
                                for(key in msg){
                                    $(".clientleadClass").append('<textarea class="form-control" key='+key+' value='+msg[key]+' readonly class="getClass get_clientlead-'+count+'">'+msg[key]+'</textarea>')
                                    count++
                                }
                                $(".CLemId").hide();
                            }
