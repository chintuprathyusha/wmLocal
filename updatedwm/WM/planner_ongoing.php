													...
													<div class="cprp">
														<div class="mb-4">
															...
															<div class="row">
																<div class="col-md-4">
																	<p>CPRP</p>
																	<input class="form-control" type="number" name="number"  min="1" max="100"  placeholder="Select the range till 100">
																</div>
																<div class="col-md-4">
																	<p>Reach</p>
																	<input class="form-control" type="number" name="number" min="1" max="100" placeholder="Select the range till 100">
														...
														<div class="mb-4">
															<div class="row">
																...
																<div class="col-md-4">
																	...
																	<select class="form-control select-multiple-tokenization" multiple="multiple" data-fouc data-placeholder="Campaign Markets">
																		<option value="AZ">Arizona</option>
																		<option value="CO">Colorado</option>
																		<option value="ID">Idaho</option>
																		<option value="WY">Wyoming</option>
