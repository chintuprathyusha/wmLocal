	...
	<body>
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				<div class="content">
					<div class="row row_">
						<div class="card col-xl-12 row_ mr-b-0">
							<div class="common_class row_">
								...
								<div class="buying_basket">
									<div class="form-group row upload_msg_full_width">
										...
										<div class="bb_files"
											style="display: inline-block;margin-left: 8px;font-size: 16px;margin-top: -1px;">
											<button id="uploadFileTrigger"
												style="font-size:14px;background: #f07144;border: none;color: #fff;padding: 4px 8px;border-radius: 4px;">Click
								...
								<div class="cprp_div close_">
									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<input class="inputboxstyle form-control campaign_days" type="number"
												min="0" max="365"
								...
								<div class="budget_div_ close_">
									...
									<div class="row">
										<div class="col-md-6">
											<input class="form-control campaign_days_new" type="number" min="0"
												max="365"
												onKeyUp="if(this.value>365){this.value='365';}else if(this.value<0){this.value='0';}"
												placeholder="Campaign Duration (in Days)">
...
<h5 style="color:#000">Genre Level Budget Allocation Sheet being created.Once complete you will receive it in your inbox.</h5>
									...
									<p class="uploadtext">Upload Budget Allocation Sheet Here<p>
											...
											<div class="form-group">
												<div class="col-lg-12 ss_files" style="display: inherit;">
													<button id="uploadFileTrigger2"
														style="	background: #f07144;border: none;color: #fff;padding: 9px;border-radius: 4px;">Click
														to Select File</button>
													<div class="GenreLevelFileNameDisplay displayInlineBlock"></div>
													<input type="file" style="display:none;" name="myfile"
														class="file-input-ajax" id="load-file__"
														accept=".csv, .xlsm, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
												</div>
												<div class="changediv">
								...
								<div class="budgetdivnew">
									<p class="uploadtext">Upload Budget Allocation Sheet Here<p>
											...
											<hr>
											<div class="form-group">
												<button id="uploadFileTrigger1"
													style="	background: #f07144;border: none;color: #fff;padding: 9px;border-radius: 4px;">Click
													to Select File</button>
												<div class="ChannelLevelFileNameDisplay displayInlineBlock"></div>
												<input type="file" style="display:none;" class="file-input-ajax"
													id="load-file1"
													accept=".csv, .xlsm, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
	...
	<script>
		...
		function myFunction1() {
			...
			var btnText = document.getElementById("myclick1");
