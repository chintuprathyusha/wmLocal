				...
				<div class="row row_">
					<div class="card col-xl-12 row_" >
						<div class="common_class row_" >
							...
							<div  class="buying_basket">
								<div class="form-group row upload_msg_full_width">
									<h6 class=" font-weight-semibold bb_txt" >Upload Buying Basket:</h6>
									<br>
									...
									<div class="col-lg-10 bb_files">
										...
										<input type="file" value="myfile" style="cursor: pointer;" name="myfile" class="file-input-ajax" id="load-file" accept=".csv, xlsm, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
							...
							<div class="cprp_div close_" >
								...
								<h6 class="font-weight-semibold cd" >Campaign Duration (in Days) <span class="appendcampaignduration"></span></h6>
								<div class="row">
									<div class="col-md-6">
								...
								<div class="mr-t-10 text-right" >
									...
									<button class="submit_ btn"  data-toggle="modal" data-target="#myModal_">Submit</button>
								</div>
							...
							<div class="budget_div_ close_" >
								<hr>
								<h6 class="font-weight-semibold row1" >Campaign Duration (in Days)<span class="appendcampaigndays"></span></h6>
								<div class="row">
									<div class="col-md-6">
								...
								<div class="mr-t-10 text-right" >
									...
									<button class="submit_new btn"  data-toggle="modal" data-target="#myModal_">Submit</button>
								</div>
							...
							<div class="spillover">
								...
								<div class="form-group row">
									...
									<!-- <input type="file" value="myfile" name="myfile" class="file-input-ajax" id="load-file" accept=".csv, xlsm, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"> -->


									<input type="file" name="myfile" class="file-input-ajax" id="load-file__" accept=".csv, .xlsm, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">

										<!-- <span class="red_color">Accepts only Excel files</span> -->
									</div>
									<div class="col-lg-12 submit_btn1">
										<button type="submit" class="btn btn-primary btn1" id="upl-btn__">Upload <i class="icon-upload ml-2"></i></button>
									</div>
								</div>
							...
							<div  class="budgetdivnew">
								...
								<div class="form-group row">
									...
									<div class="col-lg-12 submit_btn2">
										<button type="submit" class="btn btn-primary upbtn"  id="upl-btn1">Upload <i class="icon-upload ml-2"></i></button>
									</div>
								</div>
						...
						<div class="mr-t-10 row1" >
							...
							<button type="submit" class="btn btn-primary fadeInDown backclass" title="Previous" tooltip="Previous"><span>PREVIOUS </span></button>
							<button type="submit" class="btn btn-primary fadeInDown next_" title="Next" tooltip="Next"><span>NEXT </span></button>
