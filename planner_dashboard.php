            ...
            <div class="modal-content">
                ...
                <form class="modal-body">
                    ...
                    <span class="d-block text-muted">We'll send you instructions in email</span> -->
                        <button class="form-control up"><a href="buyingbasket.php" style="color:#fff">Re-Plan from
                                Buying Basket Upload </a></button>

                    </div>

                    <div class="form-group form-group-feedback form-group-feedback-right">
                        <button class="form-control up"><a href="planner_accelerator.php" style="color:#fff">Re-plan by
                                Uploading Revised Accelerator Plan</a></button>
                    </div>
                ...
                <div class="modal-body sl">
                    <div class="row rowsl">
                        <div class="row row_header">
                            ...
                            <div class="col-md-6">
                                <p class="down">Click here to download all the files &nbsp &nbsp
