      ...
      <ul class="nav nav-sidebar" data-nav-type="accordion">
        ...
        <li class="nav-item nav-item-submenu">
          ...
          <ul class="nav nav-group-sub" data-submenu-title="Layouts">
            ...
            <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_2/LTR/default/full/index.html" class="nav-link">Layout 2</a></li>
        ...
        <li class="nav-item nav-item-submenu">
          ...
          <ul class="nav nav-group-sub" data-submenu-title="Themes">
            ...
            <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/material/full/index.html" class="nav-link">Material</a></li>
            <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/dark/full/index.html" class="nav-link disabled">Dark <span class="badge bg-transparent align-self-center ml-auto">Coming soon</span></a></li>
            <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/clean/full/index.html" class="nav-link disabled">Clean <span class="badge bg-transparent align-self-center ml-auto">Coming soon</span></a></li>
          </ul>
        </li>
        <li class="nav-item nav-item-submenu">
          ...
          <ul class="nav nav-group-sub" data-submenu-title="Starter kit">
            <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/default/seed/layout_nav_horizontal.html" class="nav-link">Horizontal navigation</a></li>
            <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/default/seed/sidebar_none.html" class="nav-link">No sidebar</a></li>
            <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/default/seed/sidebar_main.html" class="nav-link">1 sidebar</a></li>
            <li class="nav-item nav-item-submenu">
              <a href="#" class="nav-link">2 sidebars</a>
              <ul class="nav nav-group-sub">
                <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/default/seed/sidebar_secondary.html" class="nav-link">Secondary sidebar</a></li>
                <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/default/seed/sidebar_right.html" class="nav-link">Right sidebar</a></li>
              </ul>
            </li>
            <li class="nav-item nav-item-submenu">
              <a href="#" class="nav-link">3 sidebars</a>
              <ul class="nav nav-group-sub">
                <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/default/seed/sidebar_right_hidden.html" class="nav-link">Right sidebar hidden</a></li>
                <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/default/seed/sidebar_right_visible.html" class="nav-link">Right sidebar visible</a></li>
              </ul>
            </li>
            <li class="nav-item nav-item-submenu">
              <a href="#" class="nav-link">Content sidebars</a>
              <ul class="nav nav-group-sub">
                <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/default/seed/sidebar_content_left.html" class="nav-link">Left sidebar</a></li>
                <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/default/seed/sidebar_content_right.html" class="nav-link">Right sidebar</a></li>
              </ul>
            </li>
            <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/default/seed/layout_boxed.html" class="nav-link">Boxed layout</a></li>
            <li class="nav-item-divider"></li>
            <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/default/seed/navbar_fixed_main.html" class="nav-link">Fixed main navbar</a></li>
            <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/default/seed/navbar_fixed_secondary.html" class="nav-link">Fixed secondary navbar</a></li>
            <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/default/seed/navbar_fixed_both.html" class="nav-link">Both navbars fixed</a></li>
            <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/default/seed/layout_fixed.html" class="nav-link">Fixed layout</a></li>
          </ul>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item"><a href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/RTL/default/full/index.html" class="nav-link"><i class="icon-width"></i> <span>RTL version</span></a></li>
        <!-- /main -->
