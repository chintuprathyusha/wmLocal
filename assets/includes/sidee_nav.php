...
<div class="sidebar  sidebar-main sidebar-expand-md" style="background-color:#222c31;">
  ...
  <div class="sidebar-content">
    ...
    <div class="card card-sidebar-mobile">
      <ul class="nav nav-sidebar" data-nav-type="accordion">
        ...
        <li id="userprofileid" class="nav-item nav-item-submenu">
        ...
        <li  id="createplan"  class="nav-item nav-item-submenu">
          <a href="planner_createnewplan.php" class="nav-link" style="color: #fff !important;">
        ...
        <li  id="myplans"  class="nav-item nav-item-submenu">
        ...
        <li  id="ongoingdashboard"  class="nav-item nav-item-submenu">
        ...
        <li  id="add_deleteid"  class="nav-item nav-item-submenu">
        ...
        <li  id="comple"  class="nav-item nav-item-submenu">
