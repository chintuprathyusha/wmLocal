        ...
        $.each(msg ,function(key,v){
            ...
            if (key == 'Incompleted') {
                ...
                for (var i = 0; i < v.length; i++) {
                    ...
                    ap1 += '<td  style="width:124px;">'+v[i]['CampaignName']+ '</td>'
                    ap1 += '<td  style="width:127px;">'+v[i]['ClientName']+'</td>'
                    ap1 += '<td  style="width:132px;">'+v[i]['BrandName']+'</td>'
                ...
                for (var i = 0; i < v.length; i++) {
                    ...
                    ap += '<td  style="width:124px;">'+v[i]['CampaignName']+'</td>'
                    ap += '<td  style="width:127px;">'+v[i]['ClientName']+'</td>'
                    ap += '<td  style="width: 132px;">'+v[i]['BrandName']+'</td>'
