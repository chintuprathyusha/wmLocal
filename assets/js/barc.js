$(document).ready(function () {
    ...
    $('#load-file').on('change', function () {
        ...
        $(".acceleratorFileNameDisplay").html('<p class="file_nameBarc">' + file_name_ + ' <img src="assets/images/delete.svg" style="width:15px" class="deleteFile"></p>')
        fileReader.onloadend = function (e) {
            ...
            $.ajax(settings11).done(function (msg) {
                ...
                if (msg.status) {
                    ...
                    $('.acceleratorFileDetails').html('<p>' + msg.file_name + '</p>')
